...
if (!empty($start_date) && !empty($end_date)) {
    ...
    $sql2 = "SELECT order_main.ord_employeeID, order_main.ord_total, order_main.ord_orderDate, employee.emp_employeeID, employee.emp_branchID, branch_main.b_ID, branch_main.b_name 
        FROM order_main
        INNER JOIN employee ON order_main.ord_employeeID = employee.emp_employeeID
